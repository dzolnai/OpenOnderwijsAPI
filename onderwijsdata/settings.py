# Django settings for onderwijsdata project.
...
SECRET_KEY = 'Mni|Rf/nedP8;hS;1jFjm^=sO^lj}k.s'
...
ROOT_URLCONF = 'onderwijsdata.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'onderwijsdata.wsgi.application'
...
SWAGGER_SETTINGS = {
    "exclude_namespaces": ['grouproles'],  # List URL namespaces to ignore
    "api_version": API_VERSION,  # Specify your API's version
