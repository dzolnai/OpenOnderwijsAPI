...
urlpatterns = patterns('api.views',
                       ...
                       url(r'^v1/groups/(?P<group_id>[0-9]+)$', group_detail, name='group-detail'),
                       url(r'^v1/grouproles$', grouprole_list, name='grouprole-list'),
                       url(r'^v1/grouproles/(?P<grouprole_id>[0-9]+)$', grouprole_detail, name='grouprole-detail'),
                       ...
                       url(r'^v1/buildings/(?P<building_id>\w+)$', building_detail, name='building-detail'),
